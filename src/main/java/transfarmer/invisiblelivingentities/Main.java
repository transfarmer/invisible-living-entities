package transfarmer.invisiblelivingentities;
...
public class Main {
    public static final String MOD_ID = "invisiblelivingentities";
    public static final String MOD_NAME = "invisible living entities";
